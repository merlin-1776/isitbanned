...
banLocations:
  - state: "Virginia"
    ...
    year: 2014
    sourceUrl: "https://en.wikipedia.org/wiki/Two_Boys_Kissing"
  - state: "Virginia"
    district: "Bedford County Public Schools"
    year: 2022
    sourceUrl: "https://www.marshall.edu/library/bannedbooks/two-boys-kissing/"
  - state: "Texas"
    district: "Keller ISD"
    year: 2022
  - state: "Florida"
  ...
  - state: "Utah"
    ...
    year: 2022
totalChallenges: 25
description: "Two Boys Kissing by David Levithan follows LGBTQ+ teens attempting a world-record kiss, narrated by a chorus of men lost to AIDS. Banned for LGBTQ+ content and sexual themes."
amazonUrl: "https://www.amazon.com/dp/0307931919?tag=isitbanned-20"
...
A parent in [Fauquier County, Virginia](https://en.wikipedia.org/wiki/Two_Boys_Kissing) petitioned to remove the book from school libraries in 2014, arguing that the cover art (showing two boys kissing) violated the school's rules against public displays of affection. The request was denied. In 2022, Moms for Liberty challenged it in [Bedford County, Virginia](https://www.marshall.edu/library/bannedbooks/two-boys-kissing/) alongside other LGBTQ+ titles. The book has been banned or challenged in Texas, Florida, and Utah as part of broader efforts to remove LGBTQ+ content from schools.
